static const char x86_cap_strs[] =
	...
	"\x0b\x01""cqm_llc\0"
#endif
#if REQUIRED_MASK12 & (1 << 0)
	"\x0c\x00""cqm_occup_llc\0"
#endif
#if REQUIRED_MASK12 & (1 << 1)
	"\x0c\x01""cqm_mbm_total\0"
#endif
#if REQUIRED_MASK12 & (1 << 2)
	"\x0c\x02""cqm_mbm_local\0"
#endif
	...
	"\x10\x19""cldemote\0"
#endif
#if REQUIRED_MASK16 & (1 << 27)
	"\x10\x1b""movdiri\0"
#endif
#if REQUIRED_MASK16 & (1 << 28)
	"\x10\x1c""movdir64b\0"
#endif
