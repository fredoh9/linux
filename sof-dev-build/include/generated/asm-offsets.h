...
#define TASK_threadsp 2392 /* offsetof(struct task_struct, thread.sp) */
#define TASK_stack_canary 1168 /* offsetof(struct task_struct, stack_canary) */

#define TASK_TI_flags 0 /* offsetof(struct task_struct, thread_info.flags) */
#define TASK_addr_limit 2520 /* offsetof(struct task_struct, thread.addr_limit) */
